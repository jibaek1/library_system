...
public class LibraryView {
    ...
    private String currentStudnetName = null;
    ...
    public void start() {
        ...
        while (true) {
            ...
            if (currentStudentId == null) {
                ...
                System.out.println("현재 로그인 유저 : " + currentStudentId);
            }
    ...
    private void login() throws SQLException {
        ...
        if (studentDTO == null) {
            ...
            currentStudnetName = studentDTO.getName();
            System.out.println("로그인 성공 : " + currentStudnetName);
        }
    }
