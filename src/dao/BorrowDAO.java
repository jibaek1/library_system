...
public class BorrowDAO {
    ...
    public void returnBook(int bookId, int studentPK) throws SQLException{
        ...
        // select 힌트
        // book_id = ? AND student_id = ? AND return_date is null
        String checkSql2 = "SELECT * FROM borrows where book_id = 1 AND student_id = 3 AND return_date IS NULL ";
